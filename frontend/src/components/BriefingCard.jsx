...
export default function BriefingCard({ initial }) {
    ...
    return (
        <div className="zm-card bg-[#09090B] text-white border-0" data-testid="briefing-card">
            ...
            <div className="p-6">
                {!briefing ? (
                    <div className="py-8 text-center">
                        ...
                        <button onClick={generate} disabled={loading} className="inline-flex items-center gap-2 px-4 py-2 bg-white text-[#09090B] text-xs uppercase tracking-[0.15em] font-bold hover:bg-[#F4F4F5]" data-testid="briefing-generate">
