            ...
            <div className="px-8 py-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-0 zm-card mb-8" data-testid="report-types">
                    {REPORT_TYPES.map((t, i) => (
                        <div key={t.v} className={`p-6 ${i < 2 ? "md:border-r border-b md:border-b-0" : ""} border-[#E4E4E7]`}>
                ...
                {active && (
                    <div className="zm-card p-6 mb-6" data-testid="report-active">
                        ...
                        <pre className="bg-[#F4F4F5] border-l-2 border-[#002EB8] p-4 text-xs overflow-x-auto font-mono">{JSON.stringify(active.data, null, 2)}</pre>
                    </div>
                )}
                ...
                <div className="zm-card overflow-x-auto">
                    <table className="w-full text-sm">
                        ...
                        <tbody>
                            ...
                            {reports.map((r) => (
                                <tr key={r.id} className="border-b border-[#E4E4E7] last:border-b-0">
                                    ...
                                    <td className="px-4 py-3 text-right">
                                        <button onClick={() => setActive(r)} className="text-[#002EB8] text-xs uppercase tracking-[0.15em] font-bold hover:underline">View</button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
