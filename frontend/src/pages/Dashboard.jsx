            ...
            <div className="px-8 pb-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-0 zm-card mb-6" data-testid="dashboard-stats">
                    {stats.map((s, i) => (
                        <div
                            key={s.label}
                            className={`p-6 ${i < 3 ? "border-b lg:border-b-0 lg:border-r border-[#E2E8F0]" : ""} ${i < 2 ? "sm:border-b-0 sm:border-r" : ""}`}
                        >
                    ...
                    <div className="zm-card p-6 lg:col-span-2">
                        ...
                        <ResponsiveContainer width="100%" height={240}>
                            <LineChart data={data.charts.leads_over_time}>
                                ...
                                <XAxis dataKey="date" tick={{ fontSize: 11, fill: "#71717A" }} stroke="#E2E8F0" />
                                <YAxis tick={{ fontSize: 11, fill: "#71717A" }} stroke="#E2E8F0" />
                                <Tooltip
                                    contentStyle={{
                        ...
                        {data.charts.leads_by_status.length === 0 ? (
                            ...
                            <ResponsiveContainer width="100%" height={200}>
                                <BarChart data={data.charts.leads_by_status} layout="vertical">
                                    ...
                                    <YAxis type="category" dataKey="name" tick={{ fontSize: 10, fill: "#71717A" }} width={90} stroke="#E2E8F0" />
                                    <Tooltip cursor={{ fill: "rgba(37,99,235,0.05)" }} contentStyle={{ background: "#0F172A", border: "none", borderRadius: 12, color: "#fff", fontSize: 12 }} />
                                    <Bar dataKey="value">
                    ...
                    <RecentList
                        ...
                        renderItem={(l) => (
                            <>
                                ...
                                <span className="zm-badge bg-[#F8FAFC] text-[#0F172A]">{l.status}</span>
                            </>
                        )}
                    />
                    <RecentList
    ...
    return (
        <div className="zm-card">
            <div className="flex items-center justify-between p-6 border-b border-[#E2E8F0]">
                ...
                <Link to={link} className="text-xs uppercase tracking-[0.15em] font-bold text-[#2563EB] hover:underline flex items-center gap-1">
            ...
            <div>
                {items.length === 0 ? (
                    ...
                    <div key={it.id || i} className="flex items-center justify-between px-6 py-4 border-b border-[#E2E8F0] last:border-b-0">
                        {renderItem(it)}
                    </div>
                ))}
            </div>
