        ...
        <div className="min-h-screen bg-[#FAF7F2]">
            ...
            <header className="bg-[#FAF7F2]">
                <div className="max-w-7xl mx-auto px-6 lg:px-12 py-5 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        <Link to="/login" className="text-sm font-semibold text-[#0E0F11] hover:text-[#FF562D] px-3 py-2" data-testid="landing-login">Sign in</Link>
            ...
            <section className="relative overflow-hidden">
                <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16 lg:py-24 grid lg:grid-cols-12 gap-12 items-center relative">
                    {/* Decorative blob */}
                    <div className="absolute top-10 right-0 w-[500px] h-[500px] rounded-full bg-[#FFE6DC] blur-3xl opacity-70 -z-0"></div>
                    <div className="absolute bottom-0 left-1/3 w-[300px] h-[300px] rounded-full bg-[#FFF7C2] blur-3xl opacity-50 -z-0"></div>

                    <div className="lg:col-span-7 relative z-10">
                        <span className="zm-tag-pill mb-6"><Sparkle size={11} weight="fill" className="text-[#FF562D] mr-1" /> AI Marketing OS</span>
                        <h1 className="font-display text-5xl md:text-7xl lg:text-[96px] font-black tracking-[-0.04em] leading-[0.95] mt-6">
                            Convert more<br />
                            with marketing<br />
                            that <span className="italic text-[#FF562D]">actually</span> works.
                        </h1>
                        ...
                        <div className="flex flex-wrap items-center gap-6 mt-8 text-xs text-[#52525B] font-semibold">
                            <span className="flex items-center gap-1.5"><CheckCircle size={14} weight="fill" className="text-[#0FB39A]" /> No credit card</span>
                            <span className="flex items-center gap-1.5"><CheckCircle size={14} weight="fill" className="text-[#0FB39A]" /> Setup in 2 min</span>
                            <span className="flex items-center gap-1.5"><CheckCircle size={14} weight="fill" className="text-[#0FB39A]" /> Cancel anytime</span>
                        </div>
                    </div>
                    <div className="lg:col-span-5 relative z-10">
                        <div className="relative">
                            {/* Mock dashboard card stack */}
                            <div className="bg-white border border-[#EDE5D4] rounded-3xl p-6 shadow-[0_8px_0_0_#0E0F11] rotate-1">
                                <div className="flex items-center justify-between mb-4">
                                    <span className="zm-section-label">Live · Last 24h</span>
                                    <span className="w-2 h-2 rounded-full bg-[#0FB39A] animate-pulse"></span>
                                </div>
                                ...
                                <div className="mt-5 space-y-2.5">
                                    {[
                                        ["Google Ads", "Paid", 32, "#FF562D"],
                                        ["SEO", "Organic", 24, "#0FB39A"],
                                        ["Cold Email", "Organic", 18, "#0E0F11"],
                                        ["LinkedIn", "Paid", 14, "#FFD300"],
                                    ].map(([n, t, p, c]) => (
                                        <div key={n}>
                            ...
                            <div className="absolute -bottom-6 -left-8 bg-[#0E0F11] text-white px-5 py-3 rounded-2xl shadow-brand-pop-lg -rotate-2 hidden md:block">
                                <p className="font-display text-2xl font-black tracking-tight"><span className="text-[#FF562D]">87%</span> on track</p>
            ...
            <section className="border-y border-[#EDE5D4] bg-white">
                <div className="max-w-7xl mx-auto px-6 lg:px-12 py-10">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-x-12 gap-y-4 opacity-60">
                        {["ACME", "STELLA", "OUTPOST", "PHOENIX", "VECTRA", "NORTH&CO"].map((n) => (
                            <span key={n} className="font-display text-2xl font-black tracking-tighter text-[#0E0F11]">{n}</span>
                        ))}
                    </div>
                </div>
            </section>
            ...
            <section className="max-w-7xl mx-auto px-6 lg:px-12 py-24">
                <div className="grid md:grid-cols-12 gap-8 mb-14 items-end">
                    <div className="md:col-span-7">
                        ...
                        <h2 className="font-display text-4xl md:text-6xl font-black tracking-tighter leading-[1.0] mt-5">
                            One platform.<br />
                            Every <span className="text-[#FF562D]">growth</span> step.
                        </h2>
                    </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                    {[
                        { icon: Globe, title: "Landing Page Builder", desc: "AI-generated copy, drag-and-drop sections, instant publish on a hosted URL.", c: "#FF562D" },
                        { icon: Robot, title: "AI Copywriting", desc: "Groq-powered drafting tuned to your business profile, channel and tone.", c: "#0FB39A" },
                        { icon: Target, title: "Paid + Organic Mix", desc: "AI distributes budgets between Google Ads, SEO, content & cold outreach.", c: "#FFD300" },
                        { icon: Megaphone, title: "6 Channels", desc: "Email, SMS, WhatsApp, Facebook, Instagram, LinkedIn — from one composer.", c: "#FF562D" },
                        { icon: ChartLineUp, title: "Real-time Analytics", desc: "Live revenue, pipeline value, target progress — all updated by the second.", c: "#0E0F11" },
                        { icon: CheckCircle, title: "Guaranteed Leads", desc: "Set monthly lead targets, track pace and forecast in one dashboard.", c: "#0FB39A" },
                    ].map((f, i) => (
                        <div key={i} className="zm-card p-7 hover:shadow-brand-pop-lg hover:-translate-y-0.5 transition-all">
            ...
            {/* Stats strip */}
            <section className="bg-[#0E0F11] text-white">
                <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16 grid grid-cols-2 md:grid-cols-4 gap-8">
                    {[
                        ...
                        <div key={l}>
                            <p className="font-display text-5xl md:text-7xl font-black tracking-tighter text-[#FF562D]">{v}</p>
            ...
            <section className="bg-[#FAF7F2] py-24">
                <div className="max-w-4xl mx-auto px-6 text-center">
                    ...
                    <h2 className="font-display text-5xl md:text-7xl font-black tracking-tighter mb-6 leading-[1.0] mt-6">
                        Marketing,<br />minus the <span className="italic text-[#FF562D]">noise</span>.
                    </h2>
            ...
            <footer className="bg-[#0E0F11] text-white">
                <div className="max-w-7xl mx-auto px-6 lg:px-12 py-10 flex flex-col md:flex-row items-center justify-between gap-4">
                    <div className="flex items-center gap-2.5">
                        <div className="w-8 h-8 bg-[#FF562D] flex items-center justify-center rounded-xl">
