            ...
            <div className="px-8 py-6">
                <div className="bg-white border border-[#E2E8F0] border-l-2 border-l-[#F59E0B] p-6 mb-6">
                    ...
                    <p className="text-sm text-[#71717A] leading-relaxed">
                        Email and SMS are <span className="font-bold text-[#0F172A]">live out of the box</span>.
                        ...
                        return (
                            <div key={c.id} className="zm-card p-6" data-testid={`integration-${c.id}`}>
                                <div className="flex items-start justify-between mb-3">
                                    ...
                                    <span className={`zm-badge ${isConnected ? "bg-[#10B981] text-white" : "bg-[#F8FAFC] text-[#71717A]"}`}>
