            ...
            <div className="px-8 py-6 grid lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="zm-card p-6">
                        ...
                        {lead.score_reason && (
                            <div className="mt-4 p-3 bg-[#F4F4F5] border-l-2 border-[#002EB8]">
                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="zm-card">
                        ...
                        {showLog && (
                            <form onSubmit={submitLog} className="p-6 border-b border-[#E4E4E7] bg-[#F4F4F5] space-y-3" data-testid="log-comm-form">
                        ...
                        {showAI && (
                            <div className="p-6 border-b border-[#E4E4E7] bg-[#F4F4F5] space-y-3" data-testid="ai-reply-panel">
                                ...
                                {aiReply && (
                                    <div className="bg-white border-l-2 border-[#002EB8] p-3">
                        ...
                        <div data-testid="comm-history">
                            {comms.length === 0 ? (
                                ...
                                return (
                                    <div key={c.id} className={`p-5 border-b border-[#E4E4E7] last:border-b-0 flex gap-3 ${isInbound ? "bg-[#F4F4F5]" : "bg-white"}`}>
                                        <div className="w-8 h-8 bg-white border border-[#E4E4E7] flex items-center justify-center flex-shrink-0">
                                            <Icon size={14} weight="bold" />
                                        </div>
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-2 mb-1">
                                                <span className="zm-badge bg-[#09090B] text-white inline-flex items-center gap-1">
                                            ...
                                            <p className="text-sm whitespace-pre-wrap leading-relaxed text-[#09090B]">{c.content || "(campaign send)"}</p>
                                        </div>
                                    </div>
                                );
                            })}
...
function Field({ label, value }) {
    return (
        <div className="flex justify-between gap-3 border-b border-[#F4F4F5] pb-2 last:border-b-0 last:pb-0">
