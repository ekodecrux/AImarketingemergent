            ...
            <div className="px-4 sm:px-6 lg:px-8 py-6">
                <div className="bg-white border border-[#E2E8F0] p-6 mb-6 border-l-2 border-l-[#2563EB]">
                    ...
                    <p className="text-sm text-[#71717A] leading-relaxed">
                        Trigger scrape jobs from <span className="font-bold text-[#0F172A]">Leads → Scrape</span>. Discovered leads
                ...
                <div className="zm-card overflow-x-auto" data-testid="scraping-jobs-table">
                    <table className="w-full text-sm">
                        ...
                        <tbody>
                            ...
                            {jobs.map((j) => (
                                <tr key={j.id} className="border-b border-[#E2E8F0] last:border-b-0">
